...
class AbstractLevel(yaml.YAMLObject):
    ...
    def from_yaml(loader, node):
        ...
        def easy_level_constructor(loader, node):
            Class = EasyLevel
            sp = {}
            sp['map'] = Class.get_map()
            sp['obj'] = Class.get_objects()
            return sp
        ...
        def medium_level_constructor(loader, node):
            ...
            my_obj = Class.get_objects()
            my_obj.config = {'enemy': data['enemy']}
            sp['map'] = Class.get_map()
            sp['obj'] = my_obj
            return sp
        ...
        loader.add_constructor(u"!easy_level", easy_level_constructor)
        loader.add_constructor(u"!medium_level", medium_level_constructor)
        loader.add_constructor(u"!hard_level", hard_level_constructor)
